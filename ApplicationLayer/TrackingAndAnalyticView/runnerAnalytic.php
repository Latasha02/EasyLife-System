    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <a href="./runnerUpdate.php" class="list-group-item">Analytic Report</a>
      ...
      <div class="col-lg-9">
        <br>
        <form action = "runnerUpdateStatus.php" method = "POST" enctype = "multipart/form-data" style = "margin-left: auto; margin-right: auto">

          <h2 style = "text-align: center"><b>Total Delivered Order List</b></h2>
