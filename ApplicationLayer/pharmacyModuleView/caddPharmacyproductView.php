...
<script>
    ...
    var x = document.getElementById("pharmacyproductPic").files[0];
    var y = x.name;
  ...
  <div class="row">
      ...
      <tr>
        ...
        <input type="button" value="Select File" id="demo" onclick="document.getElementById('pharmacyproductPic').click();">
                    <input type="file" accept="image/*" name="pharmacyproductPic" id="pharmacyproductPic" onchange="load(event)" style="display: none;"></td>
      </tr>
      <tr></tr>
      <tr></tr>
      <tr>
        <th>Pharmacy Product Name</th>
        <td><input class="form-control" name="pharmacy product Name" required="required" placeholder="pharmacy's product Name"></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input class="form-control" name="pharmacyproductDetail" required="required" placeholder="pharmacy's product Details"></td>
      </tr>
      <tr>
        <th>Pharmacy product Quantity</th>
        <td><input class="form-control" name="pharmacyproductQuantity" placeholder="pharmacyproductQuantity" required="required"></td>
      </tr>
