...
<body>
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <b><a href="#" class="list-group-item">Pets Department</a></b>
  ...
  foreach($pharmacyproductData as $row){?>
      ...
      <tr>
        ...
        <td><input class="form-control" name="pharmacyproductPrice" value="<?=$row['pharmacyproductPrice']?>" required="required"></td>
      </tr>
     
      <tr>
        <th>Pharmacy Product Details</th>
        <td><input class="form-control" name="pharmacyproductDetail" value="<?=$row['pharmacyproductDetail']?>" readonly></td>
      </tr>
      <tr>
        <th>Pharmacy Product Quantity</th>
        <td><div><input class="form-control" name="pharmacyproductQuantiy" value="<?=$row['pharmacyproductQuantity']?>" required="required"></td>
      </tr>
      <tr>
        <th>Action</th>
