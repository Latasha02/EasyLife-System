...
$pharmacy = new pharmacyproductController();
$data = $pharmacy->viewAll();
...
foreach($data as $row){
          echo "<tr><td>"
          . '<img src="uploadimage/'.$row['pharmacyproductPic'].'"/>'
          . "</td><td>".$row['pharmacyproductName']."</td>"
          . "<td>RM".$row['pharmacyproductPrice']."</td>"
          . "<td>".$row['pharmacyproductDetail']."</td>";
          ?>
         <td><form action="" method="POST">
        <input type="button" class="btn btn-primary" onclick="location.href='editpharmacyView.php?pharmacyID=<?=$row['pharmacyproductID']?>'" value="EDIT">  
        <input type="hidden" name="pharmacyproductID" value="<?=$row['pharmacyproductID']?>">
        <input type="hidden" name="pharmacyproductID" value="<?=$row['pharmacyproductID']?>"><input type="submit" name="delete" value="DELETE">
            </form>
                </td>
                <?php
                  echo "</tr>";
      ...
      <table>
                <td><input type="button" class="btn btn-primary" onclick="location.href='addpharmacyproductView.php'" value="Add Pharmacy Product">
