...
foreach($data as $row){
        ...
        <input type="button" class="btn btn-primary" onclick="location.href='editpharmacyproductView.php?pharmacyproductID=<?=$row['pharmacyproductID']?>'" value="EDIT">  
