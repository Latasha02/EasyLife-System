  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <tbody>
          ...
          <td>
          <input type="button" class="btn btn-primary" onclick="location.href='editFoodView.php?foodID=<?=$row['foodID']?>'" value="EDIT"><br>
          <input type="hidden" name="foodID" value="<?=$row['foodID']?>"><br>
          <input type="hidden" name="foodID" value="<?=$row['foodID']?>"><input type="submit" name="delete" value="DELETE">
                </td>
          </form>
                <?php
                  echo "</tr>";
        ...
        <table>
          <td><input type="button" class="btn btn-primary" onclick="location.href='addFoodView.php'" value="Add Food">
