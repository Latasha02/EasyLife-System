...
<script>
    ...
    var x = document.getElementById("petproductPic").files[0];
    var y = x.name;
  ...
  <div class="row">
      ...
      <tr>
        ...
        <input type="button" value="Select File" id="demo" onclick="document.getElementById('petproductPic').click();">
                    <input type="file" accept="image/*" name="petproductPic" id="petproductPic" onchange="load(event)" style="display: none;"></td>
      </tr>
      <tr></tr>
      <tr></tr>
      <tr>
        <th>petproduct Name</th>
        <td><input class="form-control" name="petproductName" required="required" placeholder="petproduct's Name"></td>
      </tr>
      <tr>
        <th>petproduct Price</th>
        <td><input class="form-control" name="petproductPrice" placeholder="petproduct Price" required="required"></td>
      </tr>
      <tr>
        ...
        <td>  
          ...
          <option value="Dry petproduct">&nbsp;Food</option>
          <option value="Wet petproduct">&nbsp;Toys</option>
          <option value="Wet petproduct">&nbsp;Shampoo</option>
          <option value="Wet petproduct">&nbsp;Cage</option>
          </select>
        </td>
      </tr>
      <tr>
        <th>petproduct Details</th>
        <td><input class="form-control" name="petproductDetail" required="required" placeholder="petproduct's Details"></td>
      </tr>
      <tr>
        <th>petproduct Quantity</th>
        <td><input class="form-control" name="petproductQuantity" placeholder="petproduct Quantity" required="required"></td>
      </tr>
      <tr>
        <th>Action</th>
